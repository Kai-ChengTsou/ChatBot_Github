...
class FacsSolver:
    ...
    def computeFacsWeights(self, point_mat):
        ...
        mh_ctl_list = [
            ...
            ['CTRL_expressions_browRaiseinR', "innerBrowRaiserR", 0.5], # fix for high brows, default = 1
            ['CTRL_expressions_browRaiseinL', "innerBrowRaiserL", 0.5], # fix for high brows, default = 1

            ['CTRL_expressions_browRaiseouterR', "innerBrowRaiserR", 0.5], # fix for high brows, default = 1
            ['CTRL_expressions_browRaiseouterL', "innerBrowRaiserL", 0.5], # fix for high brows, default = 1
            ...
            ['CTRL_expressions_eyeBlinkL', "eyesCloseR", 1.0, "eyesUpperLidRaiserR", -1.0], # fix for async blink, defaul = eyesCloseL
